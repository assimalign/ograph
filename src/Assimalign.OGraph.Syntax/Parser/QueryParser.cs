...
public sealed partial class QueryParser
{
    ...
    //        {
    //            context.AddDiagnostic(new QueryDiagnostic(
    ...
    ////{
    ////    private readonly IList<QueryDiagnostic> diagnostics;
    ////    public QueryParserContext()
    ////    {
    ////        this.diagnostics = new List<QueryDiagnostic>();
    ////    }

    ////    public IEnumerable<QueryDiagnostic> Diagnostics => this.diagnostics;
    ////    public void AddDiagnostic(QueryDiagnostic diagnostic) => this.diagnostics.Add(diagnostic);
    ////}
    ...
    //private abstract class QueryNodeParser
    //{


    //    public abstract QueryNode Parse(ref TokenLexer lexer, QueryParserContext context, QueryNode node);
    //}


    //private class RootParser : QueryNodeParser
    //{
    //    public override QueryNode Parse(ref TokenLexer lexer, QueryParserContext context, QueryNode node)
    //    {
    //        if (node is not RootQueryNode root)
    //        {
    //            return node;
