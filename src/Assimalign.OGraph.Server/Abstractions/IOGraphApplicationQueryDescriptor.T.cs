...
public interface IOGraphApplicationQueryDescriptor<T>
{
    ...
    /// <param name="middleware"></param>
    /// <returns>The current descriptor.</returns>
    IOGraphApplicationQueryDescriptor<T> UseMiddleware(OGraphGdmVertexMiddleware middleware);
    /// <summary>
    /// 
    /// </summary>
    ...
    /// <param name="resolver"></param>
    /// <returns>The current descriptor.</returns>
    IOGraphApplicationQueryDescriptor<T> UseResolver(OGraphGdmVertexResolver resolver);
    /// <summary>
