...
{
    public const string AttributeFullName = "Assimalign.OGraph.PickComplexTypeAttribute";
        ...
        IncrementalValuesProvider<PickObjectTypeContext> provider = context.SyntaxProvider.ForAttributeWithMetadataName(
            ...
            transform: static (context, _) =>
            {
                ...
                var source = new PickObjectTypeContext()
                {
                    ...
                    PickTypeName = declaration.GetLiteralAttributeArgumentOfType<string>(AttributeFullName, "Name"),
                    ExcludeGdmType = declaration.GetLiteralAttributeArgumentOfType<bool>(AttributeFullName, "ExcludeGdmType"),
                    GdmTypeNamespace = declaration.GetLiteralAttributeArgumentOfType<string>(AttributeFullName, "GdmTypeNamespace"),
                    Names = declaration.GetArrayAttributeArgumentOfType<string>(AttributeFullName, "Properties"),
                };
