...
public class GdmEntityType : GdmType, IOGraphGdmEntityType
{
    public GdmEntityType(
        ...
        GdmEntityKey key,
        GdmGraph graph,
        [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.All)] Type runtimeType) : base(graph)
    {
        Name = name;
    ...
    public override GdmTypeKind Kind { get; } = GdmTypeKind.Entity;
    public GdmEntityKey Key { get; } = default!;
